# FreeAgent puts the powerline style in zsh ! (https://github.com/jeremyFreeAgent/oh-my-zsh-powerline-theme)
...
PROMPT="$POWERLINE_SEC1_BG$POWERLINE_SEC1_TXT"$venv_status" $POWERLINE_USER_NAME %k%f$POWERLINE_SEC1_FG%K{blue}"$'\ue0b0'"%k%f%F{white}%K{blue} "$POWERLINE_CURRENT_PATH"%F{blue}"$POWERLINE_GIT_INFO_LEFT" %k"$'\ue0b0'"%f "
